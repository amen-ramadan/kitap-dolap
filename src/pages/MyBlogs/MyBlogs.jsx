...
import EditAndRemoveButtons from "../../components/Button/EditAndRemoveBlogButtons";

const overlayBg = "#1d659433";

export default function MyBlogs() {
  const { myBlogs, fetchMyBlogs, isLoading, lastAction } = useBlogsStore();
              ...
              {myBlogs?.map((blog) => (
                <Grid key={blog.id} sx={{ width: "46%" }}>
                  ...
                  >
                    ...
                    >
                      <span>@ {blog.writerBlogName}</span>
                      <EditAndRemoveButtons blog={blog} />
                    </Typography>
                  </Paper>
                </Grid>
              ))}
